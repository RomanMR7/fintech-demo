  ...
  return (
    <div className="grid gap-5">
      <PageHeader
        ...
        title="Сценарии"
        description="Каждый сценарий выполняет реальное действие в локальной базе: меняет статусы, баланс, апелляции, уведомления и audit log. Это главный раздел для живого показа инвестору или клиенту."
      />
      ...
      <EducationBlock
        items={[
          ...
          "После каждого шага обновляются события, поэтому audit log становится живой историей демонстрации.",
