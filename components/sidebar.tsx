  ...
  return (
    <aside className="card sticky top-6 hidden h-[calc(100vh-3rem)] flex-col overflow-hidden rounded-[var(--radius-xl)] p-3 lg:flex">
      ...
      <div className="mt-3 border-t border-ink/10 pt-3">
        <Link
          href="/contact"
          className="focus-ring mb-3 flex min-h-12 items-center justify-between gap-3 rounded-[1rem] border border-jade/25 bg-jade/10 px-3 py-3 text-sm font-semibold text-ink transition hover:-translate-y-0.5 hover:bg-jade/15"
        >
          <span>
            <span className="block text-[0.65rem] font-bold uppercase tracking-[0.12em] text-jade">Контакты</span>
            <span className="mt-0.5 block truncate">Презентация и консультация</span>
          </span>
          ...
          <div id="mobile-navigation-drawer" className="card mx-auto flex max-h-[92vh] w-full max-w-md flex-col overflow-hidden rounded-[var(--radius-xl)] bg-porcelain">
            ...
            <div className="border-t border-ink/10 p-4">
              <Link
                ...
                className="focus-ring mb-4 flex min-h-12 items-center justify-between gap-3 rounded-[1rem] border border-jade/25 bg-jade/10 px-3 py-3 text-sm font-semibold text-ink"
              >
                <span>
                  <span className="block text-[0.65rem] font-bold uppercase tracking-[0.12em] text-jade">Контакты</span>
                  <span className="mt-0.5 block">Презентация и консультация</span>
                </span>
                <span className="rounded-full bg-jade px-2 py-1 text-[0.65rem] font-bold uppercase tracking-[0.08em] text-white">PDF</span>
              </Link>
